...
//	users     map[int64]*updates.updatesQueue
//
//	// Repositories.
...
//
//		usersLock: sync.Mutex{},
//		users:     make(map[int64]*updates.updatesQueue),
//
//		authRepo:    postgres.NewUserPostgres(pool),
...
//	app.getCmd = commands.NewGetDataCmd(app)
//	app.subDirCmd = commands.NewSubDirCmd(app)
//
...
//		cmd commands.Cmd
//	}{
//		{key: "Показать чек-лист", cmd: commands.NewShowTodoListCmd(app)},
//	}
